...
def loginuser(request):
    if request.method == 'GET':
        ...
        if user is None:
            return render(request,'todo/loginuser.html',{'form':AuthenticationForm(),'error':'Username and Password not match'})
        else:
            login(request, user)
            return redirect('currenttodos')
...
def viewtodo(request,todo_pk):
    ...
    if request.method == 'GET':
        ...
        try: 
            ...
            return render(request, 'todo/viewtodo.html',{'todo':todo,'form':form,'error':'Bad text attempt. Try again!'})
